...
export class SingupPage {
  ...
  readonly getErrorManagerInvalidPass: Locator;

  constructor(page: Page) {
    this.page = page;
    this.getSignUpBtn = page.locator(
      "xpath=//button[@qa-automation='SignUpBtn']"
    );
    this.getUserNameSP = page.locator(
      "xpath=//input[@qa-automation='Username']"
    );
    ...
    this.getConfirmPassword = page.locator(
      "xpath=//input[@qa-automation='ConfirmPassword']"
    );
    this.getBtnNext = page.locator("xpath=//button[@qa-automation='btn-next']");
    this.getuserDropdownMenu = page.locator(
      "xpath=//button[@qa-automation='userDropdownMenu']"
    );
    this.getErrorManagerInvalidPass = page.locator(
      "xpath=//app-validation-message[@class='error-title']"
    );
  }
